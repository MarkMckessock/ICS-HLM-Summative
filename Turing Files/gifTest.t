...
View.Update
const level_1 : int := Pic.FileNew("../_img/environment/level_1.jpg")
...
procedure movement
    ...
    cls
    Pic.Draw(level_1, spongebobPos.x + camera.x, spongebobPos.y + camera.y, picCopy)
...
Pic.FileNewFrames("../_img/menu/logo.gif",logo_pics,delayTime3)
...
Pic.FileNewFrames("../_img/menu/play-selected.gif",play_selected_pics,delayTime4)
...
Pic.FileNewFrames("../_img/menu/play-unselected.gif",play_unselected_pics,delayTime5)
...
quit_sprite:= Sprite.New(quit_selected_pic)
